...
export const en: Dictionary = {
  ...
  lookup: {
    ...
    intro:
      "Enter your identification number to check your registration status and download your certificate.",
  ...
  admin: {
    ...
    details: {
      ...
      approveConfirm: "Are you sure you want to approve this registration?",
      ...
      cancel: "Cancel",
      confirm: "Confirm",
      noPayment: "The registrant has not submitted any payment information yet.",
    ...
    settings: {
      ...
      intro:
        "What you enter here is shown to registrants on the registration success page.",
      save: "Save",
      saving: "Saving...",
    ...
    errors: {
      ...
      notFound: "Registration not found.",
      invalidTransition: "This registration cannot take that action in its current state.",
      rateLimited: "Too many attempts. Please wait a moment and try again.",
